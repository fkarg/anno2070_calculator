...
export const PRODUCTION_NODES: readonly ProductionNode[] = [
  primary('eco', 'ecoFish', 'Fishery', 'Fish_Qoor.png', [250, 364, 571, 800], 1),
  primary('eco', 'ecoTea', 'Tea plantation', 'Tea_Qoor.png', [375, 375, 500, 750], 60),
  primary('eco', 'ecoHealthFood', 'Health food factory', 'Health food_Qoor.png', [0, 667, 857, 1000], 360),
  ...
  primary('eco', 'ecoCommunicators', 'Electronics factory', 'Communicator_Qoor.png', [0, 571, 800, 1250], 600, true),
  ...
  primary('eco', 'ecoBioDrinks', 'Health drink factory', 'Bio drinks_Qoor.png', [0, 0, 833, 1136], 950),
  ...
  primary('eco', 'ecoPastaDishes', 'Pasta production', 'Pasta dishes_Qoor.png', [0, 0, 667, 909], 250),
  ...
  primary('eco', 'eco3DProjectors', '3D projector plant', '3D Projector_Qoor.png', [0, 0, 0, 750], 1, true),
  ...
  primary('eco', 'ecoServiceBots', 'Robot factory', 'Service bots_Qoor.png', [0, 0, 0, 666 + 2 / 3], 1200, true),
  ...
  primary('tycoon', 'tycoonFish', 'Fishery', 'Fish_Qoor.png', [250, 364, 571, 800], 1),
  primary('tycoon', 'tycoonLiquor', 'Distillery', 'Liquor_Qoor.png', [300, 333, 300, 750], 60),
  primary('tycoon', 'tycoonConvenienceFood', 'Food supply factory', 'Convenience Food_Qoor.png', [0, 577, 714, 857], 360),
  ...
  primary('tycoon', 'tycoonPlastics', 'Plastic factory', 'Plastics_Qoor.png', [0, 667, 1000, 1667], 600),
  ...
  primary('tycoon', 'tycoonLuxuryMeals', 'Gourmet factory', 'Luxury meal_Qoor.png', [0, 0, 833, 1111], 250),
  ...
  primary('tycoon', 'tycoonChampagne', 'Champagne cellar', 'Champagne_Qoor.png', [0, 0, 1042, 1389], 950),
  ...
  primary('tycoon', 'tycoonJewelry', 'Jewelry manufactory', 'Jewelery_Qoor.png', [0, 0, 0, 665], 1),
  ...
  primary('tycoon', 'tycoonPharmaceuticals', 'Healthcare office', 'Pharmaceuticals_Qoor.png', [0, 0, 0, 571], 1200),
  ...
  primary('tech', 'techFish', 'Fishery', 'Fish_Qoor.png', [800, 800, 1600], 1),
  primary('tech', 'techFunctionalFood', 'Functional food factory', 'Functional food_Qoor.png', [299, 444, 1250], 50),
  material('tech', 'techAlgaeFunctionalFood', 'Aquafarm', 'Algae_Qoor.png', 'techFunctionalFood', 1),
  primary('tech', 'techFunctionalDrinks', 'Energy drink factory', 'Functional drinks_Qoor.png', [301, 735, 1250], 100),
  ...
  primary('tech', 'techImmunityDrugs', 'Immunity drug manufacturer', 'Immunity Drugs_Qoor.png', [0, 500, 667], 1),
  ...
  primary('tech', 'techNeuroimplants', 'Cybernetic factory', 'Neuroimplants_Qoor.png', [0, 667, 667], 600),
  ...
  primary('tech', 'techLaboratoryInstruments', 'Laboratory outfitter', 'Laboratory instruments_Qoor.png', [0, 0, 444], 1),
  ...
  primary('tech', 'techBionicSuits', 'Bionics factory', 'Bionic Suits_Qoor.png', [0, 0, 1481], 600),
