...
export const BUILDINGS = {
  ...
  underwaterWarehouse: logisticsBuilding('Underwater warehouse', 'Underwater-ware-icon.png', -40, -3, 0, 'Underwater_Warehouse', 'The underwater depot equivalent; deep-sea islands settle with a deep sea warehouse (base load).'),
...
export const BUILDING_PLACEMENTS: Record<BuildingId, Placement> = {
  ...
  underwaterWarehouse: 'underwater',
