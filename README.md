...
- Faction-local Growth milestones separate current-tier completion, ascension gates, newly established tiers, and recurring-demand unlock checkpoints. Producer-specific `+1 BUILDING on ISLAND` actions update actual owned counts and immediately advance the live plan.
- Current Production, Coverage, island balances, and Needs use recurring demands unlocked by actual empire population; planned population unlocks remain confined to Growth forecasts.
...
- Model exact retention/ascension satisfaction minimums and partially fulfilled satisfaction categories.
